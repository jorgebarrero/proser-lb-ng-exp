...
//   columns = [
//     { prop: 'inv_asignation_name', name: 'Asignation', width: 200 },
//     { prop: 'inv_asignation_schedule_name', name: 'Horario', width: 100 },
//     { prop: 'inv_asignation_status', name: 'Estado', width: 50 },
//   ];
...
//     this.selected = [];
//     this.invAsignationService.getAllRecords(query)
//     .subscribe( data => {
...
//   onGetActive_Records() {
//     this.selected = [];
//     const query = JSON.stringify({where: {inv_asignation_status: 'A'}});
//     console.log('query', query);

//     this.invAsignationService.getSelectedRecords(query)
//     .subscribe( data => {
//       data === undefined ? this.masterlist = 0 : this.masterlist = 1;
//       console.log('data', data);
//               this.original_list = data;
...
//     this.selected = [];
//     const query = JSON.stringify({where: {inv_asignation_status: 'I'}});
//     console.log('query', query);
...
//           id: x.inv_asignation_id,
//           status: x.inv_asignation_status,
//           chk: x.inv_asignation_chk,
//           nombre: x.inv_asignation_name,
//           nombre_corto: x.inv_asignation_shortname,
//           tipo: x.inv_asignation_type,
//           identificacion: x.inv_asignation_legal_id,
//           numero_interno: x.inv_asignation_internal_id,
//           id_turno: x.inv_asignation_schedule_id,
//           nombre_turno: x.inv_asignation_schedule_name,
//         };
//       });
...
//         return d.inv_asignation_name.toLowerCase().indexOf(val) !== -1 || !val;
//       });
...
//       localStorage.setItem("Asignation", JSON.stringify(selected))
//       this.router.navigate(['/configuration/asignation/edit']);
//       // this.router("/configuration/asignation/edit")
...
//         this.router.navigate(['/configuration/asignation/add']);
//         // this.router("/configuration/asignation/edit")
