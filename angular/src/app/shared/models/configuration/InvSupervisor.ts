export class InvSupervisor {
      ...
      inv_supervisor_type: string;
      inv_supervisor_legal_id: string;
      inv_supervisor_internal_id: string;
      inv_supervisor_schedule_id: string;
      inv_supervisor_schedule_name: string;

}

export interface InvSupervisorInterface {
