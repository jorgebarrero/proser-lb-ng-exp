...
export class EntranteIntervaloService {
 ...
 */
  ...
  getList(item): Observable<any> {
    ...
    const apiURL = `${this.apiRootProser}api/rep-entrante-intervalo/list`;
    const res = this.http.post(apiURL, consultas_SQL);
      // console.warn('Entrante INTERVALO *************' , apiURL, consultas_SQL);
      // console.log(res);
    return res;
    }
