...
@Component({
  selector: 'app-detalle-asignaciones-config',
  templateUrl: './detalle-asignaciones-config.component.html',
  styleUrls: ['./detalle-asignaciones-config.component.scss']
})
export class DetalleAsignacionesConfigComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    let storedOptions = this.proser_store.detalle_asignaciones.options;
    ...
    if (storedOptions) {
      this.options = this.proser_store.detalle_asignaciones.options;
    }
  ...
  ngOnDestroy() {
    ...
    // this.onMismoDia();
    this.proser_store.detalle_asignaciones.selection = this.selection;
    this.proser_store.detalle_asignaciones.options = this.options;
