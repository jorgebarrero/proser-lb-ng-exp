...
import { DetalleAuxiliaresService, ExcelService } from './../../../../shared/services';

@Component({
  selector: 'app-detalle-auxiliares-list',
  templateUrl: './detalle-auxiliares-list.component.html',
  styleUrls: ['./detalle-auxiliares-list.component.scss']
})
export class DetalleAuxiliaresListComponent implements OnInit {
  ...
  constructor(
    private conexionDesconexionService: DetalleAuxiliaresService,
  ...
  ngOnInit() {
    ...
    if (this.proser_store.detalle_auxiliares.selection) {
