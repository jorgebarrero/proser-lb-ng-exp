...
@Component({
  selector: 'app-manual-intervalo-config',
  templateUrl: './manual-intervalo-config.component.html',
  styleUrls: ['./manual-intervalo-config.component.scss']
})
export class ManualIntervaloConfigComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    let storedOptions = this.proser_store.manual_intervalo.options;
    ...
    if (storedOptions) {
      this.options = this.proser_store.manual_intervalo.options;
    }
  ...
  ngOnDestroy() {
    ...
    this.proser_store.manual_intervalo.selection = this.selection;
    this.proser_store.manual_intervalo.options = this.options;
