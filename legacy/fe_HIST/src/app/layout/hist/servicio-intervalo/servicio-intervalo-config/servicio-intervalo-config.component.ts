...
@Component({
  selector: 'app-servicio-intervalo-config',
  templateUrl: './servicio-intervalo-config.component.html',
  styleUrls: ['./servicio-intervalo-config.component.scss']
})
export class ServicioIntervaloConfigComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    let storedOptions = this.proser_store.servicio_intervalo.options;
    ...
    if (storedOptions) {
      this.options = this.proser_store.servicio_intervalo.options;
    }
  ...
  ngOnDestroy() {
    ...
    this.proser_store.servicio_intervalo.selection = this.selection;

    this.proser_store.servicio_intervalo.options = this.options;
