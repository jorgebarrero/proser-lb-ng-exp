...
Thank you for your interest in `PROSER`, a project
administered by Maprotel.

Contributing to `PROSER` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.Maprotel.com/agreements/Maprotel/PROSER)
...
```
  ...
  Maprotel, Inc. ("Maprotel"), You (as defined below) accept and
  agree to the following terms and conditions for Your present and
  future Contributions submitted to Maprotel. Except for the license
  granted in this Agreement to Maprotel and recipients of software
  distributed by Maprotel, You reserve all right, title, and interest
  ...
  1. Definitions
     ...
     Agreement with Maprotel.

     "Contribution" shall mean any original work of authorship,
     including any modifications or additions to an existing work, that
     is intentionally submitted by You to Maprotel for inclusion in,
     or documentation of, any of the products owned or managed by
     Maprotel ("Work"). For purposes of this definition, "submitted"
     means any form of electronic, verbal, or written communication
     sent to Maprotel or its representatives, including but not
     limited to communication or electronic mailing lists, source code
     control systems, and issue tracking systems that are managed by,
     or on behalf of, Maprotel for the purpose of discussing and
     improving the Work, but excluding communication that is
     conspicuously marked or otherwise designated in writing by You as
     "Not a Contribution."

  2. You Grant a Copyright License to Maprotel

     Subject to the terms and conditions of this Agreement, You hereby
     grant to Maprotel and recipients of software distributed by
     Maprotel, a perpetual, worldwide, non-exclusive, no-charge,
     royalty-free, irrevocable copyright license to reproduce, prepare
     derivative works of, publicly display, publicly perform,
     sublicense, and distribute Your Contributions and such derivative
     works under any license and without any restrictions.

  3. You Grant a Patent License to Maprotel

     Subject to the terms and conditions of this Agreement, You hereby
     grant to Maprotel and to recipients of software distributed by
     Maprotel a perpetual, worldwide, non-exclusive, no-charge,
     ...
     Maprotel under this Section applies only to those patent claims
  ...
  4. You Have the Right to Grant Licenses to Maprotel
  ...
  6. No Warranties or Conditions
     ...
     Maprotel acknowledges that unless required by applicable law or
  ...
  7. Submission on Behalf of Others
     ...
     may submit it to Maprotel separately from any Contribution,
  ...
  8. Agree to Notify of Change of Circumstances
     ...
     You agree to notify Maprotel of any facts or circumstances of
     which You become aware that would make these representations
     inaccurate in any respect. Email us at callback@Maprotel.com.
```
