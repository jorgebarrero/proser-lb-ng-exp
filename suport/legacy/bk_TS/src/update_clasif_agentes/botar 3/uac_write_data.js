...
function writeAgentesClasif(agentInventory, fecha_inicio, opciones) {
  ...
  const agent_table = 'a_clasif_agentes';
  const agent_table_hist = 'a_clasif_agentes_hist';
  ...
  return new Promise(function (resolve, reject) {
    ...
    for (var i = 0; i < result.length; i++) {
      ...
      record = {
        ...
        id_global: 1,
        __CLASIF_DE_AGENTES__: 2,
        id_inv_clasif_agentes: prefijo_id + i,
        ...
        nombre_horarios: fun.nombre_horarios(result[i].horario),
