...
import { DetalladoAuxiliaresService, ExcelService } from './../../../../shared/services';



@Component({
  selector: 'app-detallado-auxiliares-list',
  templateUrl: './detallado-auxiliares-list.component.html',
  styleUrls: ['./detallado-auxiliares-list.component.scss']
})
export class DetalladoAuxiliaresListComponent implements OnInit {
  ...
  constructor(
    private detalladoAuxiliaresService: DetalladoAuxiliaresService,
  ...
  ngOnInit() {
    ...
    if (this.proser_store.detallado_auxiliares.selection) {
  ...
  let consulta_SQL  = this.selection;
    ...
    this.detalladoAuxiliaresService.getList(consulta_SQL)
    .subscribe(res => {
