...
@Component({
  selector: 'app-detallado-asignaciones-config',
  templateUrl: './detallado-asignaciones-config.component.html',
  styleUrls: ['./detallado-asignaciones-config.component.scss']
})
export class DetalladoAsignacionesConfigComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    let storedOptions = this.proser_store.detallado_asignaciones.options;
    ...
    if (storedOptions) {
      this.options = this.proser_store.detallado_asignaciones.options;
    }
  ...
  ngOnDestroy() {
    ...
    // this.onMismoDia();
    this.proser_store.detallado_asignaciones.selection = this.selection;
    this.proser_store.detallado_asignaciones.options = this.options;
