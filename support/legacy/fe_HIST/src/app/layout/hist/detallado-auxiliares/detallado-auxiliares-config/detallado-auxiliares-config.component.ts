...
@Component({
  selector: 'app-detallado-auxiliares-config',
  templateUrl: './detallado-auxiliares-config.component.html',
  styleUrls: ['./detallado-auxiliares-config.component.scss']
})
export class DetalladoAuxiliaresConfigComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    let storedSelection = this.proser_store.detallado_auxiliares.selection;

    let storedOptions = this.proser_store.detallado_auxiliares.options;

    if (storedSelection) {
      this.selection = this.proser_store.detallado_auxiliares.selection;
    }


    if (storedOptions) {
      this.options = this.proser_store.detallado_auxiliares.options;
    }
  ...
  ngOnDestroy() {
    ...
    // this.onMismoDia();
    this.proser_store.detallado_auxiliares.selection = this.selection;
    this.proser_store.detallado_auxiliares.options = this.options;
