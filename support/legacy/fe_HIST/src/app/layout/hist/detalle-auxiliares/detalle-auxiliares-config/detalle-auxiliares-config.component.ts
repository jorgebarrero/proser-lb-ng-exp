...
@Component({
  selector: 'app-detalle-auxiliares-config',
  templateUrl: './detalle-auxiliares-config.component.html',
  styleUrls: ['./detalle-auxiliares-config.component.scss']
})
export class DetalleAuxiliaresConfigComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    let storedSelection = this.proser_store.detalle_auxiliares.selection;

    let storedOptions = this.proser_store.detalle_auxiliares.options;

    if (storedSelection) {
      this.selection = this.proser_store.detalle_auxiliares.selection;
    }


    if (storedOptions) {
      this.options = this.proser_store.detalle_auxiliares.options;
    }
  ...
  ngOnDestroy() {
    ...
    // this.onMismoDia();
    this.proser_store.detalle_auxiliares.selection = this.selection;
    this.proser_store.detalle_auxiliares.options = this.options;
