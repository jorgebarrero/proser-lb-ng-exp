...
@Component({
  selector: 'app-entrante-diario-config',
  templateUrl: './entrante-diario-config.component.html',
  styleUrls: ['./entrante-diario-config.component.scss']
})
export class EntranteDiarioConfigComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    let storedOptions = this.proser_store.entrante_diario.options;
    ...
    if (storedOptions) {
      this.options = this.proser_store.entrante_diario.options;
    }
  ...
  ngOnDestroy() {
    ...
    this.proser_store.entrante_diario.selection = this.selection;
    this.proser_store.entrante_diario.options = this.options;
