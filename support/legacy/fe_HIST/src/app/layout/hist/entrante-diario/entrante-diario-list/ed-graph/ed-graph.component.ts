...
@Component({
  selector: 'app-ed-graph',
  templateUrl: './ed-graph.component.html',
  styleUrls: ['./ed-graph.component.scss']
})
export class EdGraphComponent implements OnInit {
...
// bar chart
  ...
  crearGrafico() {
    ...
    this.barChartLabels = [
      'Gráfico de llamadas entrantes por dia'
    ];
