...
@Component({
  selector: 'app-operativo-detallado-config',
  templateUrl: './operativo-detallado-config.component.html',
  styleUrls: ['./operativo-detallado-config.component.scss']
})
export class OperativoDetalladoConfigComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    let storedOptions = this.proser_store.operativo_detallado.options;
    ...
    if (storedOptions) {
      this.options = this.proser_store.operativo_detallado.options;
    }
  ...
  ngOnDestroy() {
    ...
    this.proser_store.operativo_detallado.selection = this.selection;
    this.proser_store.operativo_detallado.options = this.options;
